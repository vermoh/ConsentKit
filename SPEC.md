...
| Д4 | Инлайн-блоки выросли 69 → 89 КБ из-за кода брендинга, который большинству не нужен. Вырезать на этапе сборки (--no-branding или автодетект по конфигу) | сборщик | ~полдня |
