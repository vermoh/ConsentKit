...
# РЕЕСТР ДОЛГОВ (зафиксировано 27.08.2026, возврат — по решению владельца)
...
Закрыто из прежних замечаний: база автоблока расширена до топ-50 (v0.3.1, задача у Агента A).
