...
| # | Долг | Зона | Оценка |
|---|---|---|---|
| Д1 | Плагин WordPress не запускался на живом WordPress (только php -l 7.4/8.5 + стаб-харнесс). Нужен смоук на реальной установке (Docker: wordpress + mysql) | плагин | ~полдня |
